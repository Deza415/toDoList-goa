...
import (
	...
	todoapi "github.com/Deza415/toDoList-goa"
...
func main() {
	...
	)
	{
		...
		todoEndpoints.Use(debug.LogPayloads())
		todoEndpoints.Use(log.Endpoint)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, todoEndpoints, &wg, errc, *dbgF)
		}
