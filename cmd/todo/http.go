...
import (
	...
	todosvr "github.com/Deza415/toDoList-goa/gen/http/todo/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, todoEndpoints *todo.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
